...
% Define max mass flow for each pump (m^3/s) 
constants.umax1=1/90; 
constants.umax2=1/90;
constants.umax3=1/90;

% Defining minimum mass flow for each pump (m^3/s)
constants.umin1=0; 
constants.umin2=0;
constants.umin3=0; 
